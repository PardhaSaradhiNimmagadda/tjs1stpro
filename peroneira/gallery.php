...
include "admin/database/update.php";
 ...
 <?php
            ...
            <a class="example-image-link whoweare-2" href='admin/<?php echo $projects[$i]['images'] ?>' data-lightbox="example-set" data-title="Interior-Design" > <img width="300" height="200" src="admin/<?php echo $projects[$i]['images'] ?>"  alt="<?php echo $projects[$i]['title'] ?>"></a>
