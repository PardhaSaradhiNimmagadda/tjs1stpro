...
<title>View Contacts | The Joint Services</title>
	...
	<div class="row">
		<div class="main-bg">
			...
			<div class="breadcrumbs-notify">
				<a href="dashboard.php" title=""> Dashboard / </a> <a href="contacts.php" class="current-page" title=""> View Contacts </a>
                    ...
                    <div class="col-md-12">
                        <div class="widget-body">
                            <div class="widget-heading purple">
                                <i class="icon-table pull-left"></i><h3 class="pull-left">Contacts</h3>
                                <ul>
                                    ...
                                    <div class="streaming-table">
                                            ...
                                            <table id="stream_table" class='table table-striped table-bordered'>
                                              <thead>
                                                ...
                                                <?php
                                                    $contacts = array();
                                                    $contactsobj = new Select;
                                                    $contacts = $contactsobj->selectAll("contacts");
                                                ...
                                                ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><?php echo $contacts[$i]['mobile'] ?></td>
                                                  </tr>
